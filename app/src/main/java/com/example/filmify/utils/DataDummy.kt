...
object DataDummy {
    ...
    fun generateDummyTvShows(): List<Movies> {

        val tvShows = ArrayList<Movies>()

        tvShows.add(Movies("ts1",
                "Brata",
