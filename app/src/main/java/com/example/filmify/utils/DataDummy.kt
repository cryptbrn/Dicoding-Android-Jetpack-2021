...
object DataDummy {
    ...
    fun generateDummyTvShows(): List<Movie> {

        val tvShows = ArrayList<Movie>()

        tvShows.add(Movie("ts1",
                "Brata",
