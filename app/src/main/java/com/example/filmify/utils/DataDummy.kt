package com.example.filmify.utils

import com.example.filmify.data.remote.ApiResponse

object DataDummy {

    fun generateDummyMovies(): List<ApiResponse.MoviesResponse> {

        val movies = ArrayList<ApiResponse.MoviesResponse>()

            movies.add(ApiResponse.MoviesResponse(1,
                "Indonesian",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/Abnm1Ws3JH0ReCfEhLMPwPcMcGO.jpg",
            "2014",
            null,
            null,
            "The Raid",
            ...
            movies.add(ApiResponse.MoviesResponse(2,
                    "Indonesian",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/olA39iaXISiKEkACdELgr0ZRvIF.jpg",
                    "2014",
                    null,
                    null,
                    "The Raid 2",
            ...
            movies.add(ApiResponse.MoviesResponse(3,
                    "Indonesian",
                    ...
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/o1Bn2zlIDJSnM5aOljbOPTM6Kf9.jpg",
                    "2018",
                    null,
                    null,
                    "Buffalo Boys",
            ...
            movies.add(ApiResponse.MoviesResponse(5,
                    "Indonesian",
                    ...
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/3BxLdpoTZpuwcd8LYXSvBOzddi3.jpg",
                    "2018",
                    null,
                    null,
            ...
            movies.add(ApiResponse.MoviesResponse(6,
                    "Indonesian",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/hHgIYvgNp2Ds2vgLubfWV35YnVD.jpg",
                    "2016",
                    null,
                    null,
                    "Headshot",
            ...
            movies.add(ApiResponse.MoviesResponse(7,
                    "Indonesian",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/mH7uHT4wpMEXy6weQIojuISRdlv.jpg",
                    "2015",
                    null,
                    null,
                    "3: Alif Lam Mim",
            ...
            movies.add(ApiResponse.MoviesResponse(8,
                    "Indonesian",
                    ...
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/eU0orGizEpOli4wtN8HtfOOJDlA.jpg",
                    "2019",
                    null,
                    null,
                    "Gundala",
            ...
            movies.add(ApiResponse.MoviesResponse(9,
                    "Indonesian",
                    ...
                    "https://image.tmdb.org/t/p/w600_and_h900_bestv2/nJv6ZYsTOfkm51pJHHddWjsFE3D.jpg",
                    "2019",
                    null,
                    null,
                    "Foxtrot Six",
            ...
            movies.add(ApiResponse.MoviesResponse(10,
                    "Indonesian",
    ...
    fun generateDummyTvShows(): List<ApiResponse.MoviesResponse> {

        val tvShows = ArrayList<ApiResponse.MoviesResponse>()

            tvShows.add(ApiResponse.MoviesResponse(1,
                    "Indonesian",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/lKxP0vsBXAGD6rvGHo2aSa09sz1.jpg",
                    null,
                    "2018",
                    "Brata",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(2,
                    "English",
                    "A young surgeon with Savant syndrome is recruited into the surgical unit of a prestigious hospital. The question will arise: can a person who doesn't have the ability to relate to people actually save their lives.",
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/53P8oHo9cfOsgb1cLxBi4pFY0ja.jpg",
                    null,
                    "2017",
                    "The Good Doctor",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(3,
                    "Japanese",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/nF24ODOd7PBKZ5riiJ0W7A8hjNZ.jpg",
                    null,
                    "2014",
                    "Terror in Resonance",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(4,
                    "Japanese",
            ...
            tvShows.add(ApiResponse.MoviesResponse(5,
                    "Japanese",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/7ZhHyA0IIQOyz1hzCXpTilXg4Q2.jpg",
                    null,
                    "2004",
                    "Monster",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(6,
                    "English",
            ...
            tvShows.add(ApiResponse.MoviesResponse(7,
                    "Japanese",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/1m4RlC9BTCbyY549TOdVQ5NRPcR.jpg",
                    null,
                    "2014",
                    "Tokyo Ghould",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(1,
                    "Indonesian",
                    "The Last Wolf series tells the story of a bloodshed involving a conflict between two mafia groups. Actor Abimana Aryasatya plays Alex, the same character he played in the previous film. Alex is a member of the Mafia group Naga Hitam. The figure of Alex will be the main story of this series. One old name that came back is Fathir, played by Reza Pahlevi.",
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/4bRcDcAHkhsUUQeKt9tb8G3mt42.jpg",
                    null,
                    "2020",
                    "Serigala Terakhir",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(9,
                    "Malay",
                    ...
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/tEc7BvfmGY4mwuUZDHmxtVVrIBG.jpg",
                    null,
                    "2018",
                    "DOSA",
                    null,
            ...
            tvShows.add(ApiResponse.MoviesResponse(10,
                    "English",
                    "In the high-tech gold rush of modern Silicon Valley, the people most qualified to succeed are the least capable of handling success. Partially inspired by Mike Judge’s own experiences as a Silicon Valley engineer in the late ‘80s, Silicon Valley is an American sitcom that centers around six programmers who are living together and trying to make it big in the Silicon Valley.",
                    "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/a154rIMzbTyefodNp4NY8qjOEfC.jpg",
                    null,
                    "2014",
                    "Silicon Valley",
                    null,
